-- Migración Flyway nº 5: peticiones de acceso de teléfonos aún no autorizados.
-- Tabla creada pero todavía sin usar (el flujo de solicitud/aprobación es futuro).
