...
/**
 * APARCADO — no está enrutado ni se importa en ningún sitio (rediseño de eventos
 * en curso, 2026-09-04). Reúne la parte de asistencia que antes vivía en
 * `EventoDetalleComponent`: responder Me apunto / No voy / En duda, la ficha de
 * bebida (San Miguel) y —solo admin u organizador— mandar la convocatoria y
 * añadir asistentes a mano. Se carga solo por el `id` de la ruta, igual que el
 * detalle, para poder reengancharlo tal cual cuando se decida dónde va.
 */
@Component({
  selector: 'app-asistencia-evento',
  imports: [DatePipe, FichaBebida],
  templateUrl: './asistencia-evento.html',
})
