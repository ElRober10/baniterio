...
actual fun VisorPdf(bytes: ByteArray, url: String, modifier: Modifier) {
                ...
                PdfRenderer(pfd).use { renderer ->
                    ...
                    for (i in 0 until renderer.pageCount) {
                        renderer.openPage(i).use { pagina ->
                            ...
                            // El fondo del bitmap nace transparente: sin esto, cualquier margen
                            // del PDF que no pinte nada deja ver el fondo oscuro del tema por
                            // detrás en vez de blanco (papel).
    ...
    if (lista == null) {
        ...
        // Fondo blanco en todo el área (no solo en cada página, con el hueco entre ellas
        // incluido): es "papel", no debe verse el fondo oscuro del tema por ningún lado.
        LazyColumn(
